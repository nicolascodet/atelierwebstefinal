      ...
      <div className="container mx-auto px-4 sm:px-6 lg:px-8">
        ...
        >
          ...
          <p className="text-lg text-gray-600 max-w-2xl mx-auto">
            Have questions about The Canvas by Atelier Frames? We're here to help you experience the future of digital art.
          </p>
        </motion.div>
        ...
        <div className="grid md:grid-cols-2 gap-12 items-start max-w-6xl mx-auto">
          <motion.div
            ...
            viewport={{ once: true, margin: '-50px' }}
            transition={{ duration: 0.6 }}
            className="bg-gradient-to-br from-white to-gray-50 p-8 rounded-2xl shadow-sm border border-gray-100"
          >
            ...
            <div className="space-y-8">
              ...
              >
                ...
                <div>
                  ...
                  <a href="mailto:support@atelierframes.com" className="text-blue-600 hover:text-blue-800 transition-colors">
                    support@atelierframes.com
                  </a>
                </div>
              </motion.div>
                ...
                <div className="bg-blue-50 p-3 rounded-full text-blue-600">
                  ...
                  >
                    <path
                      ...
                      strokeLinejoin="round"
                      strokeWidth={1.5}
                      d="M12 6v6h4.5m4.5 0a2.25 2.25 0 01-2.25 2.25h-15a2.25 2.25 0 01-2.25-2.25V6.75m19.5 0A2.25 2.25 0 0019.5 4.5h-15a2.25 2.25 0 00-2.25 2.25m19.5 0v.243a2.25 2.25 0 01-1.07 1.916l-7.5 4.615a2.25 2.25 0 01-2.36 0L3.32 8.91a2.25 2.25 0 01-1.07-1.916V6.75"
                    />
                  </svg>
                </div>
                <div>
            ...
            >
              ...
              <div className="flex space-x-5">
                {[
                  ...
                  <motion.a
                    key={social.name}
                    href={`https://${social.name}.com/atelierframes`}
                    target="_blank"
                    rel="noopener noreferrer"
                    className="bg-white p-3 rounded-full shadow-sm border border-gray-200 text-gray-700 hover:text-blue-600 hover:border-blue-200 transition-colors"
          ...
          >
            {submitted ? (
              <motion.div
                ...
                className="bg-blue-50 border border-blue-100 text-blue-900 rounded-2xl p-10 text-center"
              >
                ...
                <p className="text-blue-700 mb-6">Your message has been sent successfully. We'll get back to you as soon as possible.</p>
                <motion.button
                  onClick={() => setSubmitted(false)}
                  whileHover={{ scale: 1.03 }}
                  whileTap={{ scale: 0.98 }}
                  className="px-6 py-2 border border-blue-300 text-blue-600 rounded-lg font-medium bg-white shadow-sm hover:bg-blue-50 transition-colors"
                >
